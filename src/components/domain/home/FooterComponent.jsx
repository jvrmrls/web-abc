  ...
  return (
    ...
    >
      <Box className={'lg:text-center'}>
        <p className='text-base font-medium text-center leading-none w-[180px] lg:w-[60%] mx-auto lg:text-5xl'>
          Somos los locos que creen que pueden{' '}
        </p>
        <span className='block font-black text-3xl  lg:text-8xl'>
          retar al mundo
        </span>
      </Box>
      ...
      <Box className={'w-full text-center flex flex-col gap-0 font-normal'}>
        ...
        <span className={'text-xs m-0 p-0 font-normal lg:text-base'}>
          ...
          <span className={''}>ABC Marketing Digital</span>
        </span>
      </Box>
      <Box></Box>
    </Box>
