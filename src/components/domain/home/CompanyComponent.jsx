...
function CompanyComponent() {
  return (
    ...
    >
      <img
        src={logoAbc}
        className={'block w-[60px] lg:w-[140px] absolute top-3'}
        alt='logo'
      />
      <p className='text-center text-2xl lg:text-7xl font-semibold leading-6'>
        &#161;Estamos listos para{' '}
        <span className='block text-4xl lg:text-9xl font-black'>
          retar tus ideas&#33;
        </span>
      </p>
...
const style = {
  container: {
    ...
    background:
      'linear-gradient(to bottom left, #F4456A 0 2%, #F7728A 90% 100%)'
  },
  divider: {
    width: '30%',
    minWidth: '150px',
